...
`ANTHROPIC_API_KEY` is optional. When it is absent or the provider is unavailable, Astrail uses deterministic MCP generation.
...
Use this endpoint for demos because it does not need Neon-generated data.
