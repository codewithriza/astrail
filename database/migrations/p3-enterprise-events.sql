...
revoke all on function public.claim_webhook_event(uuid,uuid,text,timestamptz) from public,anon,authenticated;grant execute on function public.claim_webhook_event(uuid,uuid,text,timestamptz) to service_role;
...
revoke all on function public.current_organization_role(uuid) from public,anon;grant execute on function public.current_organization_role(uuid) to authenticated,service_role;
