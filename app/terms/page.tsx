    ...
    <main className="min-h-screen bg-[#f7f7f5] text-neutral-950">
      <div className="mx-auto max-w-3xl px-5 py-10 sm:py-16">
        ...
        <article className="mt-10 rounded-xl border border-neutral-200 bg-white p-6 shadow-sm sm:p-10">
          ...
          <p className="mt-7 text-base leading-7 text-neutral-600">These terms govern your use of Astrail, operated by Riza Mohamed. By creating an account or using the service, you agree to them.</p>
          <div className="mt-9 space-y-8">
            ...
            <section>
              ...
              <p className="mt-2 text-base leading-7 text-neutral-600">Questions about these terms can be sent to <a className="underline" href="mailto:codewithriza@gmail.com">codewithriza@gmail.com</a>.</p>
            </section>
          </div>
        </article>
      </div>
